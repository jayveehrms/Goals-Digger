...
<body>
    ...
    <section class="home" id="home">
        <div class="text">
            ...
            <p>Your journey matters to us. We are committed to providing<br> you with reliable, efficient, and top-quality transport services. <br> Hop on, and let us take you to your destination!</p>
            <div class="home-btn">
    ...
    <section class="ride" id="ride"> 
        ...
        <div class="ride-container">
            ...
            <div class="box">
                <img class="bx bxs-calendar-check" src="" alt="">
            ...
            <div class="box">
                <img class="bx bxs-calendar-star" src="" alt="">
