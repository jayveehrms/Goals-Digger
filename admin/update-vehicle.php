                        ...
                        ?>
                            <form method ="POST"> 
                                <div class="form-group">
                                    ...
                                    <input type="text" value="<?php echo $row->v_name;?>" required name="vName">
                                </div>
                            
                                <div class="form-group">
                                    <label>Registered Number</label>
                                    <input type="text"  value="<?php echo $row->v_reg_no;?>"  name="vRegNo">
                                </div>
                                <div class="form-group">
                                    <label>Vehicle Type</label>
                                    <input type="text" value="<?php echo $row->v_type;?>"  name="vType">
                                </div>
